...
public class Worker extends RegisteredUser {
    /**
     * Worker constructor.  A subclass of RegisteredUser.  The class is
     * necessary for using instanceof to verify account type in order to
     * allow access to certain features of the app.
